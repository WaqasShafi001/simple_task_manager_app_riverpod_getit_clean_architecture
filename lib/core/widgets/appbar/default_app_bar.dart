    ...
    return AppBar(
      leading: AutoLeadingButton(
        builder: (context, LeadingType leadingType, _) {
          if (leadingType == LeadingType.noLeading) return leading ?? const SizedBox.shrink();
          return IconButton(
            icon: AppImage.svg(Assets.svgs.backArrow, height: 24.0, width: 24.0, color: context.primary),
            onPressed: () {
